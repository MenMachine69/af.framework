...
/// <summary>
/// Extension methods for SearchLookUpEdit
/// </summary>
[SupportedOSPlatform("windows")]
public static class SearchLookupEditEx
{
    /// <summary>
    ...
    public static void Setup(this DevExpress.XtraEditors.SearchLookUpEdit searchLookUpEdit, AFGridSetup setup)
    {
        bool clickset = false;
        ...
        if (setup.CmdEdit != null && setup.AllowEdit)
        {
            ...
            button.Tag = new Tuple<AFCommand?, DevExpress.XtraEditors.SearchLookUpEdit>(setup.CmdEdit, searchLookUpEdit);
        ...
        if (setup.CmdAdd != null && setup.AllowAddNew)
        {
            ...
            button.Tag = new Tuple<AFCommand?, DevExpress.XtraEditors.SearchLookUpEdit>(setup.CmdAdd, searchLookUpEdit);
            button.ImageOptions.SvgImageColorizationMode = SvgImageColorizationMode.Full;
            button.ImageOptions.SvgImageSize = new(12,12);
            button.ImageOptions.AllowGlyphSkinning = DefaultBoolean.True;
        ...
        if (setup.CmdShowDetail != null)
        {
            ...
            button.Tag = new Tuple<AFCommand?, DevExpress.XtraEditors.SearchLookUpEdit>(setup.CmdShowDetail, searchLookUpEdit);
            button.ImageOptions.SvgImageColorizationMode = SvgImageColorizationMode.Full;
            button.ImageOptions.SvgImageSize = new(12, 12);
            button.ImageOptions.AllowGlyphSkinning = DefaultBoolean.True;
        ...
        if (setup.CmdDelete != null)
        {
            ...
            button.Tag = new Tuple<AFCommand?, DevExpress.XtraEditors.SearchLookUpEdit>(setup.CmdDelete, searchLookUpEdit);
            button.ImageOptions.SvgImageColorizationMode = SvgImageColorizationMode.Full;
            button.ImageOptions.SvgImageSize = new(12, 12);
            button.ImageOptions.AllowGlyphSkinning = DefaultBoolean.True;
        ...
        if (setup.CmdGoto != null)
        {
            ...
            button.Tag = new Tuple<AFCommand?, DevExpress.XtraEditors.SearchLookUpEdit>(setup.CmdGoto, searchLookUpEdit);
            button.ImageOptions.SvgImageColorizationMode = SvgImageColorizationMode.Full;
            button.ImageOptions.AllowGlyphSkinning = DefaultBoolean.True;
        ...
        searchLookUpEdit.Properties.View.Setup(setup);
    }
    ...
    public static object? GetSelectedObject(this DevExpress.XtraEditors.SearchLookUpEdit searchLookUpEdit)
    {
    ...
    {
        if (e.Button.Tag is not Tuple<AFCommand?, DevExpress.XtraEditors.SearchLookUpEdit> cmd) return;
