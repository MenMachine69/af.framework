...
/// <summary>
/// Presenter mit einem Pivot-Control
/// </summary>
[DesignerCategory("Code")]
public class AFPresenterPivot : AFPresenterBase
{
    private readonly AFPivotGridControl grid = null!;
    ...
    /// Constructor
    /// </summary>
    public AFPresenterPivot(string caption, string description) : base(true)
    {
    ...
    /// <summary>
    /// Zugriff auf das PivotGrid-Control.
    /// </summary>
    public AFPivotGridControl PivotGrid => grid;
