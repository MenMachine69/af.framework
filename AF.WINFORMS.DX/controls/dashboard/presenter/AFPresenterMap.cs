...
/// <summary>
/// Presenter mit einem Map-Control
/// </summary>
[DesignerCategory("Code")]
public class AFPresenterMap : AFPresenterBase
{
    private readonly AFMapControl map = null!;
    ...
    /// Constructor
    /// </summary>
    public AFPresenterMap(string caption, string description) : base(true)
    {
    ...
    /// <summary>
    /// Zugriff auf das AFMapControl-Control.
    /// </summary>
    public AFMapControl Map => map;
