...
/// <summary>
/// Presenter mit einem Chart-Control
/// </summary>
[DesignerCategory("Code")]
public class AFPresenterChart : AFPresenterBase
{
    private readonly AFChartControl chart = null!;
    ...
    /// Constructor
    /// </summary>
    public AFPresenterChart(string caption, string description) : base(true)
    {
    ...
    /// <summary>
    /// Zugriff auf das AFChartControl-Control.
    /// </summary>
    public AFChartControl Chart => chart;
