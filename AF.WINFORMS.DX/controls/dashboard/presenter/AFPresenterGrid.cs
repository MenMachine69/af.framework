...
/// <summary>
/// Presenter mit einem Grid-Control
/// </summary>
[DesignerCategory("Code")]
public class AFPresenterGrid : AFPresenterBase
{
    ...
    /// Constructor
    /// </summary>
    public AFPresenterGrid(string caption, AFGridSetup setup, string description) : base(true)
    {
    ...
    /// GridView
    /// </summary>
    public GridView? View => grid.DefaultView as GridView;
