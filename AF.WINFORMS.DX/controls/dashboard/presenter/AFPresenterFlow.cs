...
/// <summary>
/// Presenter mit einem AFFlowPanel-Control
/// </summary>
[DesignerCategory("Code")]
public class AFPresenterFlow : AFPresenterBase
{
    private readonly AFFlowPanel flowpanel = null!;
    ...
    /// Constructor
    /// </summary>
    public AFPresenterFlow(string caption, string description) : base(true)
    {
        ...
        flowpanel = new() { Dock = DockStyle.Fill };

        table.Add(flowpanel, 3, 1);
    ...
    /// <summary>
    /// Zugriff auf das AFFlowPanel-Control.
    /// </summary>
    public AFFlowPanel FlowPanel => flowpanel;
