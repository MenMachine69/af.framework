...
public sealed class AFPresenterThreeValues : AFPresenterBase
{
    ...
    private readonly AFLabelGrayText lblDescription3 = null!;
    private readonly AFLabelBoldText lblValue3 = null!;
    ...
    /// Konstruktor
    /// </summary>
    public AFPresenterThreeValues() : base(true)
    {
        ...
        lblValue1 = new()
        {
            ...
            Appearance = { TextOptions = { HAlignment = HorzAlignment.Far, VAlignment = VertAlignment.Center }, FontSizeDelta = 3, Options = { UseTextOptions = true, UseFont = true } }
        };
        ...
        {
            Dock = DockStyle.Top, AllowHtmlString = true, AutoSizeMode = LabelAutoSizeMode.Vertical,
            Padding = new(5, 5, 5, 3), Visible = false,
            Appearance = { TextOptions = { HAlignment = HorzAlignment.Near, WordWrap = WordWrap.Wrap, Trimming = Trimming.EllipsisCharacter }, Options = { UseTextOptions = true } }
        };
        ...
        table.Add(lblValue3, 7, 1);


        table.SetColumn(1, TablePanelEntityStyle.Relative, 1.0f);
        table.SetRow(3, TablePanelEntityStyle.Relative, .33f);
        table.SetRow(5, TablePanelEntityStyle.Relative, .33f);
        table.SetRow(7, TablePanelEntityStyle.Relative, .34f);
        ...
        table.Rows[5].Visible = lblDescription2.Visible;
        ...
        lblDescription3.TextChanged += (_, _) =>
        {
            lblDescription3.Visible = lblDescription3.Text.IsNotEmpty();
            table.Rows[5].Visible = lblDescription3.Visible;
        };
    }
    ...
    /// Konstruktor
    /// </summary>
    public AFPresenterThreeValues(string description, string value, string value2, string value3) : this()
    {
    ...
    /// </summary>
    [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public AFLabelBoldText LabelValue3 => lblValue3;

    /// <summary>
    /// Zugriff auf das Label, dass die Beschreibung anzeigt.
    /// </summary>
    [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public AFLabelGrayText LabelDescription3 => lblDescription3;
}