...
/// <summary>
/// Presenter mit einem TreeMap-Control
/// </summary>
[DesignerCategory("Code")]
public class AFPresenterTreeMap : AFPresenterBase
{
    private readonly AFTreeMapControl map = null!;
    ...
    /// Constructor
    /// </summary>
    public AFPresenterTreeMap(string caption, string description) : base(true)
    {
        ...
        // map.BorderOptions.Visible = false;
    ...
    /// <summary>
    /// Zugriff auf das AFTreeMapControl-Control.
    /// </summary>
    public AFTreeMapControl Map => map;
