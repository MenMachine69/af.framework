...
/// <summary>
/// Editor für eine Integer Variable
/// </summary>
[ToolboxItem(false)]
[DesignerCategory("Code")]
public class AFVariableEditInteger : AFVariableEditBase
{
    ...
    public AFVariableEditInteger()
    {
        ...
        titel.Text = "Eigenschaften: <b>Ganzzahl</b>";
    ...
    public VariableInt? Variable { get; set; }
}
