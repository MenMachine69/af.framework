...
/// <summary>
/// Connects a BarManager to a Controller
/// 
/// After that any ItemClick in a bar will be routed 
/// to a controller command with the same name. 
/// There is no more need to impelement the Click event for each item.
/// </summary>
[ToolboxItem(true)]
public class AFBarManagerLink : AFVisualComponentBase
{
