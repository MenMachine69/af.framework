...
/// <summary>
/// Shell basierend auf DevExpress.XtraBars.TabForm.
/// </summary>
public class TabFormShell : TabForm, IShell, ICommandResultDisplay
{
    ...
    /// <summary>
    /// ID die das Fenster identifiziert, wenn eine Persistierung der Größe und Position gewünscht sind.
    /// </summary>
    [Browsable(true)]
    [DefaultValue(true)]
    ...
    private TabFormShellPopup? _currentPopup;
    ...
    public void ShowPopup(TabFormShellPopup popup, BarItemLink caption)
    {
        HidePopup();
...
/// <summary>
/// Popup-Fenster der TabFormShell.
/// </summary>
public class TabFormShellPopup : FormBase
{
    ...
    public TabFormShell? Shell { get; set; }
    ...
    public void ShowPopup(TabFormShell owner, BarItemLink menuentry)
    {
        Shell = owner;
